...
def main() -> None:
    ...
    expected_names = [
        ...
        "host_approvals.tool_call_identity",
        ...
        "host_approvals.approval_records_match",
        "host_approvals.pending_listing",
        "host_approvals.pending_endpoint",
        "host_approvals.transport_tool_call_id",
        ...
        "app.import_boundary",
        "packaging.tauri_config",
        "packaging.sidecar_handshake",
        "packaging.sidecar_lifecycle",
        "packaging.shell_security",
        "packaging.app_seam",
        ...
        "survey.content_bounds",
        "survey.max_files",
        "survey.tree_summary",
        "survey.forbidden_paths",
        "survey.read_only",
        "survey.import_boundary",
