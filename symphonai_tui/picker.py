"""Provider and model picker screens for the SymphonAI Textual TUI."""
...
from symphonai_api.provider_catalog import build_catalog_provider, catalog_keys
...
class ProviderPickerScreen(Screen[ProviderPickerResult | None]):
    ...
    def compose(self) -> ComposeResult:
        yield Static("SymphonAI provider setup", id="picker-title")
        yield Static(
